#!/usr/bin/perl -w
#
#indx#	table_fun.pl - Convert table in file type to another
#@HDR@	$Id$
#@HDR@
...
#
#hist#	2020-09-16 - Christopher.M.Caldwell0@gmail.com - Created
#hist#	2026-02-19 - Christopher.M.Caldwell0@gmail.com - Standard header
########################################################################
#doc#	table_fun.pl - Convert table in file type to another
#doc#	A filter/program for copying one table type to another.		#
#doc#	Knows how to read html, text with delimited columns and others.	#
#doc#	and many others.						#
#########################################################################
#
